 ...
 <i class="fa fa-search"></i>
    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
            ...
            $stmt = $conn->prepare('SELECT id_aluno, a.nome, nascimento, salario, sexo, ativo,
a.id_curso, c.nome AS nome_curso, foto
 FROM aluno a
JOIN curso c ON a.id_curso=c.id_curso
 WHERE a.nome LIKE :nome_aluno ');
            ...
            while($aluno = $stmt->fetch()) {
                ...
                ?>
                <tr>
                    <td style="width: 5%;" class="text-center bg-secondary"><?php echo $aluno['id_aluno']
                        ?></td>
                    <td style="width: 17%;">
                    ...
                    <td style="width: 15%;" class="imagem">
                        <a href="detalhes.php?id_aluno=<?= $aluno['id_aluno'] ?>">
                            <?php echo '<img src="data:image/png;base64,' . base64_encode($aluno['foto']) .
                                '" height="200px"/>'; ?>
                        </a>
                    </td>
 ...
 <button type="button" class="btn btn-link p-0 btn-excluir" style="color: red"
         data-bs-toggle="modal" data-bs-target="#meuModal" data-id="<?= $aluno['id_aluno'] ?>" data-nome="<?=
 $aluno['nome'] ?>">
...
<script>
    $(document).ready(function() {
        ...
        $('.btn-excluir').click(function() {
            ...
            let texto = `Clique em Ok para excluir o registro "<strong>${id_aluno} -
${nome}</strong>"&hellip;`;
